...
function Project() {
    return (
        <Container id='projects' className='py-5'>
            ...
            <Row className="g-4">
                {[
                    { title: "Calculator",Livelink:"https://realestate-own.netlify.app/",github: "https://github.com/yourusername/calculator",img: "calc.jpeg", text: "A simple calculator built with HTML, styled using CSS, and powered by JS for performing basic arithmetic operations efficiently."},
                    { title: "ToDo-List",Livelink:"https://realestate-own.netlify.app/",github: "https://github.com/yourusername/calculator", img: "todo.jpeg", text: "A sleek To-Do app built with HTML, CSS, and JS, offering an intuitive interface for managing tasks efficiently and stylishly." },
                    ...
                    { title: "Sign In-Form",Livelink:"https://realestate-own.netlify.app/",github: "https://github.com/vignesh333948/Sign-in-form",img: "form.jpeg", text: "A responsive sign-in form with validation." },
